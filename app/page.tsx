      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="border-t border-gray-800 bg-black p-3 sm:p-4 flex flex-col sm:flex-row items-end sm:items-center space-y-2 sm:space-y-0 sm:space-x-2">
          <textarea
            ...
            rows={1}
            disabled={loading}
            className="flex-1 w-full px-4 py-2 pr-12 border border-gray-700 rounded-3xl bg-gray-800 placeholder-gray-500 text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none overflow-hidden"
