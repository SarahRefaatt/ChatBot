  ...
  return (
    <div className="h-screen bg-gradient-to-br from-slate-50 to-blue-50/30 flex flex-col">
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Sidebar */}
        <div className="w-80 bg-white border-r border-slate-200 hidden lg:block p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-xl mx-auto">
                    {quickActions.map((action, index) => (
                      <button
                        key={index}
                        onClick={() => handleQuickAction(action.prompt)}
                        className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-all duration-200 text-left hover:border-blue-300 group"
                      >
              ...
              <div className="flex justify-start">
                <div className="flex space-x-4 max-w-[85%]">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl rounded-bl-md px-6 py-4 shadow-sm">
